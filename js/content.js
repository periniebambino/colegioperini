window.PERINI_CONTENT = {
  ...
  pillars: [
    ...
    { key: 'pertencer', title: 'Pertencer', text: 'Uma escola acolhedora onde cada aluno é conhecido pelo nome.' },
  ...
  coc: {
    ...
    items: [
      ...
      'Avaliações e simulados de acompanhamento',
  ...
  structure: {
    ...
    items: [
      ...
      { title: 'Biblioteca', text: 'Leitura, pesquisa e ampliação de repertório ao longo da trajetória escolar.' },
      { title: 'Quadra poliesportiva', text: 'Espaço para movimento, convivência e práticas esportivas.' }
    ]
  },
  finalCta: {
